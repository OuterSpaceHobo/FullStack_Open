...
describe('Blog app', function() {
    ...
    describe('when logged in', function() {
        ...
        it('users can like a blog', function() {
            cy.createBlog({ title: 'a note created by cypress', author: 'test Boy', url: 'test.com', likes: 0 })
            cy.contains('a note created by cypress').parent().find('#show-button').as('theButton')
        ...
        it('the blogs are ordered according to likes - top first', function() {
            cy.createBlog({ title: 'one like', author: 'test Boy', url: 'test.com', likes: 1 })
            cy.createBlog({ title: 'five likes', author: 'test Boy', url: 'test.com', likes: 5 })
            cy.createBlog({ title: 'ten likes', author: 'test Boy', url: 'test.com', likes: 10 })
            cy.visit('http://localhost:3000')
